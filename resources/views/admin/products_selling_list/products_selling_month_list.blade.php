...
@section('content')
	...
	<section class="content-header">					
        <div class="container-fluid my-2">
        	<div class="row mb-2">
        		<div class="col-sm-6">
        			<h5 class="fw-bold">Danh sách sản phẩm bán trong tháng <?= date('m'); ?></h1>
        		</div>
						...
						<div class="card">
							...
							<div class="card-body p-0">								
								<table id="myTable" class="table table-bordered table-hover">
									...
									<tbody>
                                        @if (!empty($SellingProductsMonth))
                                            @foreach ($SellingProductsMonth as $item)
												<tr>
