	...
	<section class="content-header">					
        <div class="container-fluid my-2">
        	<div class="row mb-2">
        		<div class="col-sm-6">
        			<?php
						$currentWeekOfMonth = ceil(date('d') / 7); // Tính tuần của tháng hiện tại
					?>
					<h5 class="fw-bold">Danh sách sản phẩm bán trong tuần thứ <?= $currentWeekOfMonth; ?> của tháng <?= date('m'); ?></h5>
        		</div>
