...
<section class="content">
	...
	<div class="container-fluid">
		<form action="" id="StaffsForm" id="StaffsForm">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="login_name" id="login_name" class="form-control" placeholder="Tên đăng nhập">
                                <p></p>	
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="password" id="password" class="form-control" placeholder="Nhập email">
                                <p></p>	
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">                                    
                            ...
                            <textarea name="address" id="address" class="form-control" cols="30" rows="5" placeholder="Nhập địa chỉ"></textarea>
                            <p></p>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="position" id="position" class="form-control">
                                    <option value="Nhân viên bán hàng">Nhân viên giao hàng</option>
                                    <option value="Nhân viên giao hàng">Nhân viên bán hàng</option>
                                </select>                                
                            </div>
                        </div>      
                    </div>
...
<script>
    ...
    $("#StaffsForm").submit(function(event){
